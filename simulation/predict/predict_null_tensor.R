...
# permute across samples # 02/25/2024
set.seed(1234)
expr <- expr[, sample(colnames(expr))]
colnames(expr) <- names(pseudotime)
###
...
saveRDS(AUC.tensor, file = "simulation/v3/predict/AUC/AUC_null_tensor.rds")

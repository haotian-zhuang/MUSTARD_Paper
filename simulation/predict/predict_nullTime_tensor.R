...
# permute pseudotime across samples # 02/27/2024
set.seed(1234)
pseudotime <- setNames(sample(pseudotime), names(pseudotime))
###
...
saveRDS(AUC.tensor, file = "simulation/v3/predict/AUC/AUC_nullTime_tensor.rds")
